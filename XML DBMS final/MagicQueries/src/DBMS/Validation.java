...
public class Validation extends Object implements Serializable {
	...
	public boolean validate() {
		...
		MagicQueriesLogger.logger.error("Failed to excute query");
		return result;
	}
...
//	/**UPDATE school
//	SET  name = "Asser" , age = 22 , length = 120.6
//	 * insert=>1 deleteAll=>2 delete=>3 updateAll=>4 update=>5 selectAll
//	 * without=>6 selectAll with=>7 select without=>8 select with=>9
//	 */
//	public static void main(String[] args) {
//		String[] input = { "UPDATE sdfs",
//			"SET  name = \"Asser\" , age = 22 , length = 120.6" };
//	}
}
